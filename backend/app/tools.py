...
REFORMULATE_PROMPT = (
    ...
    "Верни переформулированный запрос на русском языке без пояснений и кавычек.\n\nВопрос: {question}"
)
...
ANSWER_PROMPT = (
    ...
    "Отвечай обязательно на русском языке. Не используй китайский, английский или другие языки. "
    ...
    "скажи об этом прямо. Ответ кратко и по делу, со ссылками на регламенты. "
...
SUMMARIZE_PROMPT = (
    ...
    "на русском языке без пояснений и markdown."
)
